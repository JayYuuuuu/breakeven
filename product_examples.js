...
export const PRODUCT_EXAMPLES = [
  ...
  },
  {
    ...
    isNew: false, // 非新品
    singlePrice: 0,
    tierPrices: [59.8, 59.8, 69.8], // 更新售价：59.8, 59.8, 69.8
    returnRate: 0.0940,
    singleCost: 0,
...
export function generateExampleCSV() {
  ...
  const examples = [
    ...
    ['纯色棉毛', 'HYX19585', '淘宝', '否', '0', '59.80;59.80;69.80', '9.40%', '33.50;38.50;42.00'], // 更新售价：59.80;59.80;69.80
    ...
    ['纯色棉毛', 'HYX19585', '天猫', '否', '0', '59.80;59.80;69.80', '8.23%', '33.50;38.50;42.00'], // 更新售价：59.80;59.80;69.80
